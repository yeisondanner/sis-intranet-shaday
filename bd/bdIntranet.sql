...
-- Volcando estructura para tabla intranet_notas.docente_modulo
DROP TABLE IF EXISTS `docente_modulo`;
CREATE TABLE IF NOT EXISTS `docente_modulo` (
  `docente_id` int(11) NOT NULL,
  `modulo_id` int(11) NOT NULL,
  `estudiante_id` int(11) NOT NULL,
  `notas_id` int(11) NOT NULL,
  PRIMARY KEY (`docente_id`,`modulo_id`),
  KEY `modulo_id` (`modulo_id`),
  KEY `FK_docente_modulo_estudiante` (`estudiante_id`),
  KEY `FK_docente_modulo_notas` (`notas_id`),
  CONSTRAINT `FK_docente_modulo_estudiante` FOREIGN KEY (`estudiante_id`) REFERENCES `estudiante` (`estudiante_id`),
  CONSTRAINT `FK_docente_modulo_notas` FOREIGN KEY (`notas_id`) REFERENCES `notas` (`nota_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `docente_modulo_ibfk_1` FOREIGN KEY (`docente_id`) REFERENCES `docente` (`docente_id`),
  CONSTRAINT `docente_modulo_ibfk_2` FOREIGN KEY (`modulo_id`) REFERENCES `modulo` (`modulo_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
