...
CREATE TABLE IF NOT EXISTS `tb_configuration` (
  ...
  `c_color_primary` char(10) NOT NULL DEFAULT '',
  `c_color_secondary` char(10) NOT NULL DEFAULT '',
...
INSERT INTO `tb_configuration` (`idConfiguration`, `c_name`, `c_logo`, `c_description`, `c_color_primary`, `c_color_secondary`, `c_registrationDate`, `c_updateDate`) VALUES
	(1, 'asdasd', 'asdasd', 'asdasd', 'asdasd', 'asdasd', '2025-02-02 00:49:12', '2025-06-30 21:34:13');
...
-- Volcando datos para la tabla bd_users.tb_log: ~137 rows (aproximadamente)
DELETE FROM `tb_log`;
...
INSERT INTO `tb_user` (`idUser`, `u_user`, `u_password`, `u_email`, `u_profile`, `u_fullname`, `u_gender`, `u_dni`, `u_status`, `u_registrationDate`, `u_updateDate`, `u_online`, `role_id`) VALUES
	(1, 'OHl4NXRSbFRqbSs1UW9mbEpxNnNPQT09', 'OHl4NXRSbFRqbSs1UW9mbEpxNnNPQT09', 'VTJxUmZLN2x5N0FrKzJMamRtLzR3Zz09', 'OHl4NXRSbFRqbSs1UW9mbEpxNnNPQT09-group.png', 'Super Administrador Sistema Roles', 'Otro', '12345678', 'Activo', '2025-01-28 18:49:20', '2025-06-30 20:01:54', 1, 1);
