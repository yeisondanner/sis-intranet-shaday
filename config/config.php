...
const BASE_URL = "http://localhost/sis-intranet-shaday";
//Ruta de almacenamiento de archivos
const RUTA_ARCHIVOS = "./Storage/";
//Nombre del sistema
const NOMBRE_SISTEMA = "Sistema de intranet Shaday";
//Nombre de la compania
const NOMBRE_COMPANIA = "Shaday";
//Zona horaria
date_default_timezone_set('America/Lima');

//Datos de conexión a Base de Datos
const DB_HOST = "localhost";
const DB_NAME = "bd_intranet_shaday";
const DB_USER = "root";
const DB_PASSWORD = "";
